...
Taki podział był kluczowy: zamiast próbować zbudować całą aplikację naraz, każdy etap miał jasno zdefiniowany zakres i kończył się działającym, testowalnym przyrostem funkcjonalności.
